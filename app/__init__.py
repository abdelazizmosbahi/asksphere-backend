...
from models import CommunityValidator
...
CORS(app, resources={r"/*": {"origins": "https://wonderful-sky-054cb711e.2.azurestaticapps.net"}})
...
try:
    logger.info("Attempting to initialize AIContentFilter")
    ai_content_filter = AIContentFilter(modelVersion='original')
    logger.info("AIContentFilter initialized successfully")
