...
echo "Starting deployment script at $(date) from $APP_PATH" | tee -a /home/LogFiles/Application/asksphere.log
set -e
echo "Current directory: $(pwd)" | tee -a /home/LogFiles/Application/asksphere.log
echo "Listing files in $APP_PATH:" | tee -a /home/LogFiles/Application/asksphere.log
...
echo "Installing dependencies from $APP_PATH/requirements.txt at $(date)" | tee -a /home/LogFiles/Application/asksphere.log
...
/usr/bin/python3 -c "import sys; sys.path.append('$APP_PATH'); import logging; logging.basicConfig(filename='/home/LogFiles/Application/asksphere.log', level=logging.DEBUG); logging.info('Testing imports'); from app import app; logging.info('App imported successfully')" 2>&1 | tee -a /home/LogFiles/Application/asksphere.log

# Preload AI models
echo "Preloading AI models at $(date)" | tee -a /home/LogFiles/Application/asksphere.log
